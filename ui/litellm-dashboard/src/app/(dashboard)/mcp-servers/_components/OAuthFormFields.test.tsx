...
describe("OAuthFormFields", () => {
  ...
  describe("resource indicator field", () => {
    ...
    it("signals keep-existing when editing, since stored credentials are redacted from responses", () => {
      render(
        <WithForm>
      ...
      expect(
        screen.getByPlaceholderText("auto, or https://mcp.example.com/mcp (leave blank to keep existing)"),
      ).toBeInTheDocument();
    });
